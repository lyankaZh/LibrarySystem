...
namespace Library
{
    public partial class BookCreatingWindow
    {
        private readonly UnitOfWork unitOfWork = new UnitOfWork();
        CreatingBookViewModel viewModel;
        private double marginTopValue = 5;
        public BookCreatingWindow()
        {
            InitializeComponent();
            viewModel = new CreatingBookViewModel(unitOfWork);
        ...
        {
            AddNewGenreWindow addNewGenreWindow = new AddNewGenreWindow(viewModel);
            addNewGenreWindow.ShowDialog();
        }

        private void addPublisherButton_Click(object sender, RoutedEventArgs e)
        {
            AddNewPublisherWindow addNewGenreWindow = new AddNewPublisherWindow(viewModel);
            addNewGenreWindow.ShowDialog();
        }

        private void addLanguageButton_Click(object sender, RoutedEventArgs e)
        {
            AddNewLanguageWindow addNewLanguageWindow = new AddNewLanguageWindow(viewModel);
            addNewLanguageWindow.ShowDialog();
        }

        private void addAuthor_Click(object sender, RoutedEventArgs e)
        {
            AddNewAuthorWindow addNewAuthorWindow = new AddNewAuthorWindow(viewModel);
            addNewAuthorWindow.ShowDialog();
        }

        private void oneMoreAuthor_Click(object sender, RoutedEventArgs e)
        {
            newBookWindow.Height += 25;
            mainGrid.Height += 25;
